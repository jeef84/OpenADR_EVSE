...
STATUS_EFFECTIVE_CO2_THRESHOLD = f"{PREFIX}/status/effective_co2_threshold_g_per_kwh"
STATUS_LEARNED_CO2_FLOOR = f"{PREFIX}/status/learned_co2_floor_g_per_kwh"
STATUS_EFFECTIVE_FOSSIL_THRESHOLD = f"{PREFIX}/status/effective_fossil_threshold_pct"
STATUS_LEARNED_FOSSIL_FLOOR = f"{PREFIX}/status/learned_fossil_floor_pct"
STATUS_CARBON_ADAPTIVE_REASON = f"{PREFIX}/status/carbon_adaptive_reason"
STATUS_CARBON_URGENCY = f"{PREFIX}/status/carbon_urgency"
